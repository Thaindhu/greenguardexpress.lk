        ...
        var i = {
            init: function (i, t) {
                ...
                (e.elem = t),
                    ...
                    e.options.tint &&
                        ((e.options.lensColour = "none"),
                        (e.options.lensOpacity = "1")),
                          ...
                          : (this.options.showLens &&
                            ...
                            "lens" == this.options.zoomType &&
                                ((this.windowLeftPos = String(
                                    -1 *
                                        ((o.pageX - this.nzOffset.left) *
                                            this.widthRatio -
                                            this.zoomLens.width() / 2)
                                )),
                                (this.windowTopPos = String(
                                    -1 *
                                        ((o.pageY - this.nzOffset.top) *
                                            this.heightRatio -
                                            this.zoomLens.height() / 2)
                                )),
                                this.zoomLens.css({
            ...
            setWindowPostition: function (i) {
                ...
                if (isNaN(t.options.zoomWindowPosition))
                    (t.externalContainer = o(
                        "#" + t.options.zoomWindowPosition
                    )),
                        (t.externalContainerWidth =
                            t.externalContainer.width()),
                        (t.externalContainerHeight =
                            t.externalContainer.height()),
                        (t.externalContainerOffset =
                            t.externalContainer.offset()),
            ...
            swapAction: function (i, t) {
                ...
                if (
                    ...
                    e.$elem.attr("src", i),
                        ...
                        h
                            .stop(!0)
                            .fadeOut(e.options.imageCrossfade, function () {
                                o(this).remove();
                            }),
                    ...
                    e.options.constrainType &&
                        ("height" == e.options.constrainType &&
                            ...
                            "inner" == e.options.zoomType &&
                                (e.zoomWrap
                                    .parent()
                                    .css("height", e.options.constrainSize),
                        ...
                        "width" == e.options.constrainType &&
                            ...
                            "inner" == e.options.zoomType &&
                                (e.zoomWrap
                                    .parent()
                                    .css("height", e.constheight),
                                e.zoomWrap
                                    .parent()
                                    .css("width", e.options.constrainSize),
    ...
    (a.jGrowl = function (b, c) {
        0 === a("#jGrowl").length &&
            a('<div id="jGrowl"></div>')
                ...
                .appendTo(
                    c && c.appendTo ? c.appendTo : a.jGrowl.defaults.appendTo
                ),
            a("#jGrowl").jGrowl(b, c);
    }),
        ...
        a.extend(a.fn.jGrowl.prototype, {
            ...
            render: function (b) {
                var c = this,
                    ...
                    e = b.options;
                e.themeState =
                    "" === e.themeState ? "" : "ui-state-" + e.themeState;
                var f = a("<div/>")
                    .addClass(
                    ...
                    .append(
                        a("<button/>")
                            ...
                            .html(e.closeTemplate)
                    )
                    .append(
                        a("<div/>").addClass("jGrowl-header").html(e.header)
                    )
                    ...
                    .bind("click.jGrowl", function () {
                        return (
                            a(this).parent().trigger("jGrowl.beforeClose"), !1
                        );
                    })
                    .parent();
                a(f)
                    .bind("mouseover.jGrowl", function () {
                        a(".jGrowl-notification", c.element).data(
                            "jGrowl.pause",
                            !0
                        );
                    })
                                ...
                                function () {
                                    a.support.opacity === !1 &&
                                        ...
                                        null !== a(this).data("jGrowl") &&
                                            "undefined" !=
                                                typeof a(this).data("jGrowl") &&
                                            (a(this).data("jGrowl").created =
                                                new Date()),
                ...
                a(this.element)
                    ...
                    this.notifications.length > 0 &&
                        (0 === this.defaults.pool ||
                            a(this.element).find(".jGrowl-notification:parent")
