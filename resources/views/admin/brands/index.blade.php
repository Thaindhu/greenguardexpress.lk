...
@section('title')
    Greenguardexpress.lk | Admin | Brands
@endsection
                            ...
                            <div class="col-lg-4">
                                <div class="page-header-breadcrumb">
                                    <ul class="breadcrumb-title">
                                        ...
                                        <li class="breadcrumb-item"><a href="#!">All Brands</a> </li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <a href="{{ route('brand.create') }}"><button class="btn btn-inverse mb-3"><i
                                                ...
                                                <tbody>
                                                    @foreach ($brands as $item)
                                                        <tr>
                                                            ...
                                                            <td><img width="25%" src="{{ $item->image1_path }}"
                                                                    alt="" srcset=""></td>
                                                            <td><img width="25%" src="{{ $item->image2_path }}"
                                                                    alt="" srcset=""></td>
                                                            <th>
                                                                @if (!$item->is_active)
