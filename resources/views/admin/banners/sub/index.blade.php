...
@section('title')
    Greenguardexpress.lk | Admin | Middle Banners
@endsection
                            ...
                            <div class="col-lg-4">
                                <div class="page-header-breadcrumb">
                                    <ul class="breadcrumb-title">
                                        ...
                                        <li class="breadcrumb-item"><a href="#!">Middle Banners</a> </li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="page-body">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div class="row">
                                            <div class="col-sm-10">
                                                <h4 class="sub-title">Large Banners</h4>
                                            </div>
                                            <div class="col-sm-2 text-right">
                                                <a href="{{ route('sub_banner.edit') }}"><button
                                    ...
                                    <div class="card-block">
                                        <div class="row">
                                            <div class="col-xl-4 col-lg-3 col-sm-3 col-xs-12">
                                                <a href="{{ $banners->middle_banner_lg_1 }}" data-lightbox="roadtrip">
                                                    <img src="{{ $banners->middle_banner_lg_1 }}" class="img-fluid m-b-10"
                                                        alt="">
                                                </a>
                                                <p>Redirecting to - <a
                                                        href="{{ $banners->middle_banner_lg_1_redirect }}">{{ $banners->middle_banner_lg_1_redirect }}</a>
                                                </p>
                                            </div>
                                            <div class="col-xl-4 col-lg-3 col-sm-3 col-xs-12">
                                                <a href="{{ $banners->middle_banner_lg_2 }}" data-lightbox="roadtrip"
                                                    data-title="Lorem ipsum dolor sit amet, consectetur adipiscing lorem impus dolorsit.onsectetur adipiscing.">
                                                    <img src="{{ $banners->middle_banner_lg_2 }}" class="img-fluid m-b-10"
                                                        alt="">
                                                </a>
                                                <p>Redirecting to - <a
                                                        href="{{ $banners->middle_banner_lg_2_redirect }}">{{ $banners->middle_banner_lg_2_redirect }}</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="sub-title">Small Banners</h4>
                                    </div>
                                    <div class="card-block">
                                        <div class="row">
                                            <div class="col-xl-2 col-lg-3 col-sm-3 col-xs-12">
                                                <a href="{{ $banners->middle_banner_sm_1 }}" data-lightbox="roadtrip"
                                                    data-title="Lorem ipsum dolor sit amet, consectetur adipiscing lorem impus dolorsit.onsectetur adipiscing.">
                                                    <img src="{{ $banners->middle_banner_sm_1 }}" class="img-fluid m-b-10"
                                                        alt="">
                                                </a>
                                                <p>Redirecting to - <a
                                                        href="{{ $banners->middle_banner_sm_1_redirect }}">{{ $banners->middle_banner_sm_1_redirect }}</a>
                                                </p>
                                            </div>
                                            <div class="col-xl-2 col-lg-3 col-sm-3 col-xs-12">
                                                <a href="{{ $banners->middle_banner_sm_2 }}" data-lightbox="roadtrip"
                                                    data-title="Lorem ipsum dolor sit amet, consectetur adipiscing lorem impus dolorsit.onsectetur adipiscing.">
                                                    <img src="{{ $banners->middle_banner_sm_2 }}" class="img-fluid m-b-10"
                                                        alt="">
                                                </a>
                                                <p>Redirecting to - <a
                                                        href="{{ $banners->middle_banner_sm_2_redirect }}">{{ $banners->middle_banner_sm_2_redirect }}</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
