...
@section('title')
    Greenguardexpress.lk | Admin | Products
@endsection
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <a href="{{ route('product.create') }}"><button class="btn btn-inverse mb-3"><i
                                                ...
                                                <tbody>
                                                    @foreach ($products as $item)
                                                        <tr>
                                                            ...
                                                            <td>{{ $item->cat_name }} / {{ $item->subcat_name }}</td>
                                                            <td>{{ $item->title }}</td>
                                                            <td>{{ $item->brand }}</td>
                                                            <td>{{ number_format($item->price, 2) }}</td>
                                                            <td>{{ number_format($item->discount_price, 2) }}
                                                                ({{ number_format($item->discount_pre, 2) }}% Off)
                                                            </td>
                                                            <th>
                                                                @if ($item->is_featured)
                                                                ...
                                                                @if ($item->is_hot_sell)
                                                                    <div class="label-main">
                                                                        <label class="label label-info">Hot Selling</label>
                                                                    </div>
                                                                @endif
                                                            ...
                                                            <th>
                                                                @if ($item->is_available == 0)
                                                                    <div class="label-main">
                                                                        <label class="label label-danger">out of
                                                                            stock</label>
                                                                    </div>
                                                                @else
                                                                    <div class="label-main">
                                                                        <label
                                                                            class="label label-success">({{ $item->stock }})
                                                                            Available</label>
                                                                    </div>
                                                                @endif
                                                            </th>
                                                            <td><img width="100%" src="{{ $item->image1_path }}"
                                                                    alt="" srcset=""></td>
